...
const BottomNavBar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-gray-950 border-t border-gray-900 z-50 flex justify-around items-center h-16 shadow-lg md:hidden opacity-0 hover:opacity-100 transition-opacity duration-300">
