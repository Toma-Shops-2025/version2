...
import { ArrowLeft, MapPin, Star, Heart, Share2, Building, DollarSign, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="p-4">
          ...
          <div className="space-y-3">
            {listing.company_name && (
              <div className="flex items-center text-gray-300">
                ...
                <span><strong>Company:</strong> {listing.company_name}</span>
              </div>
            )}
            {listing.job_type && (
              <div className="flex items-center text-gray-300">
                <Clock className="h-4 w-4 mr-2 text-green-400" />
                <span><strong>Type:</strong> {listing.job_type}</span>
              </div>
            )}
            {listing.salary && (
              <div className="flex items-center text-gray-300">
                <DollarSign className="h-4 w-4 mr-2 text-green-400" />
                <span><strong>Salary:</strong> {listing.salary}</span>
              </div>
            )}
        ...
        {listing.seller_id && (
          <div className="mb-6 border-t border-gray-800 pt-6">
            <h3 className="font-semibold text-white mb-2">About the Employer</h3>
      ...
      <div className="p-4 space-y-8 bg-black">
        <div>
          <h3 className="text-lg font-semibold mb-2 text-white">Employer Reviews</h3>
          {reviews.length === 0 ? (
            <p className="text-sm text-gray-400">No reviews for this employer yet.</p>
          ) : (
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2 text-white">More from this Employer</h3>
          {sellerListings.length === 0 ? (
            <div className="text-gray-400">No other listings from this employer.</div>
          ) : (
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2 text-white">Similar Jobs</h3>
