...
const RentalDetail = () => {
  ...
  if (loading) return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-400">Loading rental details...</p>
      </div>
    </div>
  );
  ...
  if (!listing) return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="text-center">
        <p className="text-gray-400 mb-4">Rental not found</p>
        <Button onClick={() => navigate(-1)} variant="outline">Go Back</Button>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="p-4 space-y-8 bg-black">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2 text-white">Similar Rentals</h3>
          {similarListings.length === 0 ? (
            <div className="text-gray-400">No similar rentals found.</div>
          ) : (
