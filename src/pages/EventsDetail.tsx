...
import { ArrowLeft, MapPin, Star, Heart, Share2, Calendar, Clock, Ticket } from 'lucide-react';
      ...
      <div className="p-4">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-center space-x-6">
              {listing.event_date && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white">{formatDate(listing.event_date)}</span>
                </div>
              )}
              {listing.event_time && (
                <div className="flex items-center space-x-2">
                  <Clock className="h-6 w-6 text-purple-300" />
                  <span className="text-white">{formatTime(listing.event_time)}</span>
                </div>
              )}
            </div>
          </Card>
            ...
            <div className="space-y-4">
              ...
              {listing.organizer && (
                <div>
                  ...
                  <span className="ml-2 text-gray-300">{listing.organizer}</span>
                </div>
              )}
              ...
              {listing.contact_info && (
                <div>
                  ...
                  <p className="mt-2 text-gray-300">{listing.contact_info}</p>
                </div>
              )}
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
            ...
            {listing.ticket_url ? (
              <Button 
                ...
                onClick={() => window.open(listing.ticket_url, '_blank')}
              >
              ...
              <Button 
                className="flex-1 bg-purple-600 hover:bg-purple-700 text-white"
                onClick={() => {
                  alert('Contact the organizer for more information!');
                }}
              >
                <Ticket className="h-5 w-5 mr-2" />
                Get More Info
          ...
          {sellerListings.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">More Events from {sellerName}</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {sellerListings.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-purple-400 text-sm">{item.price || 'Free'}</p>
                  </Card>
                ))}
              </div>
            </div>
          ...
          {similarListings.length > 0 && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-white">More Events Nearby</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
